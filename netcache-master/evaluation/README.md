...
```
7. cd ../p4
	a python expected.py 
	b python observed.py
...
mkdir -p results
mx client1 python3 exec_queries.py --n-servers 8 --suppress --input data/zipf_sample_200000_05.txt
...
```
(Dataset --44250 zipf and 15750 attack.txt)
mkdir -p results
...
Command For monitoring bandwidth usage is: 
cd ../control_plane
...
python3 gen_plots.py --input results/zipf_sample_60000_05_8_netcache.txt
